...
class Game:
    def __init__(self):
        ...
        self.sliders = [
            ...
            Slider((100, 220), 100, 0.5, 2.0, 1.0),
            Slider((100, 260), 100, 0.5, 2.0, 1.0),
            Slider((100, 300), 100, 0.5, 2.0, 1.0),
            Slider((100, 340), 100, 0.5, 2.0, 1.0),
            Slider((100, 380), 100, 0.5, 2.0, 1.0),
            Slider((100, 420), 100, 0.5, 2.0, 1.0),
            Slider((100, 460), 100, 0.5, 2.0, 1.0),
            Slider((100, 500), 100, 0.5, 2.0, 1.0),
            Slider((100, 540), 100, 0.5, 2.0, 1.0),
            Slider((100, 580), 100, 0.5, 2.0, 1.0)
        ]
